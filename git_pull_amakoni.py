...
def main():
    ...
    cmd = "echo 'Ashley@#$1234' | sudo -S sh -c 'cd /home/bestbeginnings_s2_havano_pro_nyyrglzxjnfn/custom-addons/havano_schools_odoo && git pull origin main' && echo 'Ashley@#' | sudo -S docker restart odoo_bestbeginnings_s2_havano_pro_nyyrglzxjnfn && echo 'Ashley@#' | sudo -S docker exec odoo_bestbeginnings_s2_havano_pro_nyyrglzxjnfn odoo -u havano_schools_odoo -d bestbeginnings_s2_havano_pro_nyyrglzxjnfn --stop-after-init"
